...
export function SettingsPage() {
  ...
  return (
    <div className="max-w-xl space-y-6">
      <div>
        <h1 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Branding</h1>
        <p className="text-sm text-slate-500 dark:text-slate-400">Customize how your portal looks to your team and visitors.</p>
      </div>
      ...
      {saved && (
        <div className="rounded border border-green-200 bg-green-50 px-3 py-2 text-sm text-green-700 dark:border-green-900/60 dark:bg-green-950/40 dark:text-green-400">
          Branding updated.
        </div>
      )}
